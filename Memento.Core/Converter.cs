...
namespace Memento.Core
{
    public class Converter : IConverter
    {
        ...
        {
            var questionPart = GetQuestionPart(cardText);
        ...
        {
            var questionText = GetQuestionPart(card);
            var answer = GetAnswerFromField(questionText, clozeName);
